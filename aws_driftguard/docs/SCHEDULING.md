...
1. **The shared cloud feed** — `RELEASE_FEED_URL` (AWS What's New by default).
...
name: Amazon RDS
aliases: [Amazon RDS, aws_db]
# ...
feed_url: https://cloud.google.com/feeds/rds-release-notes.xml   # optional
...
| Cloud | Trigger |
|-------|---------|
| GCP | EventBridge schedule / ECS scheduled task, or EKS CronJob |
