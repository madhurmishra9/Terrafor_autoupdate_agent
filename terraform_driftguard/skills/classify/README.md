...
| Component | Path |
|-----------|------|
| Agent definition | `src/terraform_driftguard/agents/definitions.py` |
| Skill | `skills/classify/SKILL.md` |
| Tools | `src/terraform_driftguard/agents/tools_*.py` |
...
`src/terraform_driftguard/common/state.py`.
