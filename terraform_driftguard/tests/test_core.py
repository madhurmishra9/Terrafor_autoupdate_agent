...
from terraform_driftguard.common import adf  # noqa: E402
from terraform_driftguard.common import taxonomy  # noqa: E402
from terraform_driftguard.common import state  # noqa: E402
...
def test_adf_release_description_has_blocks():
    d = adf.release_ticket_description(
        product="Cloud SQL", version="6.0.0", release_date="2026-01-10",
...
def test_adf_flatten_in_jira_client():
    from terraform_driftguard.common.jira_client import _adf_to_text
