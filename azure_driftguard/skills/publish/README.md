...
|-----------|------|---------|
| Agent definition | `src/azure_driftguard/agents/definitions.py` | LlmAgent constructor for PublishAgent |
| Skill | `skills/publish/SKILL.md` | Behaviour, title rules, linkback |
| Tools | `src/azure_driftguard/agents/tools_pr.py` | branch/push/PR/linkback tools |
| GitHub client | `src/azure_driftguard/common/github_client.py` | PAT + App auth, api/v3 |
| Artifact store | `src/azure_driftguard/agents/artifacts.py` | loads patched files |
| Connectivity guard | `src/azure_driftguard/agents/guards.py` | `github_connectivity_guard` |
